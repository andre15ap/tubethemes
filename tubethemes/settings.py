"""
Django settings for tubethemes project.
...
SECRET_KEY = '$_kn#vu!)or9)18^)ixs+e6yk_o)909d%fw6oq%g@#^@@w2u(7'
...
WSGI_APPLICATION = 'tubethemes.wsgi.application'
